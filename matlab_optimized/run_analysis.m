function [BASE, ZTCF, DELTA, ZVCFTable] = run_analysis(varargin)
...
% Date: 2025
    ...
    addParameter(p, 'use_checkpoints', true, @islogical);
    addParameter(p, 'verbose', true, @islogical);
    addParameter(p, 'generate_plots', true, @islogical);
    parse(p, varargin{:});
    ...
    sim_config.use_parallel = p.Results.use_parallel;
    sim_config.enable_checkpoints = p.Results.use_checkpoints;
    sim_config.verbose = p.Results.verbose;
