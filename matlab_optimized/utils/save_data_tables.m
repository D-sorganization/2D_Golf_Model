...
% Date: 2025
    ...
    if exist('ZVCFTable', 'var') && ~isempty(ZVCFTable)
    ...
    if exist('ZVCFTableQ', 'var') && ~isempty(ZVCFTableQ)
    ...
    if exist('SummaryTable', 'var') && ~isempty(SummaryTable)
    ...
    if exist('ClubQuivers', 'var') && ~isempty(ClubQuivers)
